...
public class MenuEmpresa extends AppCompatActivity {
    ...
    public void getPath(Uri uri) {
        ...
        RequestBody description = RequestBody.create(MediaType.parse("multipart/form-data"),extras.getString("Id_Emp"));
        ...
        Call<String> call = RetrofitClient.getInstance().getApi().uploadPhotoEmp(requestImage,description);
        ...
        call.enqueue(new Callback<String>() {
            ...
            public void onFailure(Call<String> call, Throwable t) {
                Toast.makeText(MenuEmpresa.this, t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
